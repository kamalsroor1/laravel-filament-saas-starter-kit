# AGENTS.md — Enterprise SaaS Starter Kit

> This file is the single source of truth for AI code assistants (Codex, Cursor, Copilot).
...
Config key: `AI_PROVIDER=Codex` / `openai` / `gemini`
...
anthropics/anthropic-sdk-php   → Codex SDK
